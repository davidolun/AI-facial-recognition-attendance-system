...
urlpatterns = [
    ...
    path("add_student_deepface/", deepface_views.add_student_deepface, name="add_student_deepface"),
    ...
    path('take_attendance_deepface/', deepface_views.take_attendance_deepface, name='take_attendance_deepface'),
